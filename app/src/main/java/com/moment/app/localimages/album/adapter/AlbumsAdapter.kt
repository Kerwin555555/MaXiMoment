...
class AlbumsAdapter(val context: Context) : BaseAdapter() {

    private val photoDirectories: MutableList<Album> = mutableListOf()
    ...
    class ViewHolder(private val itemView: View) {
        ...
        fun setData(directory: Album, selected: Boolean) {
            try {
...
//                }
                ...
                AlbumImageTask.loadThumb(itemView.findViewById<ImageView>(R.id.explorer_iv_directory_cover), file, 0.3f)
