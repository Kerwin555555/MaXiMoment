...
@Keep
public class AlbumItemFile implements Parcelable {
    public long fileId;
    public String path;
    ...
    public AlbumItemFile() {
    }

    protected AlbumItemFile(Parcel in) {
    ...
    public static final Creator<AlbumItemFile> CREATOR = new Creator<AlbumItemFile>() {
        @Override
        public AlbumItemFile createFromParcel(Parcel source) {
            return new AlbumItemFile(source);
        }

        @Override
        public AlbumItemFile[] newArray(int size) {
            return new AlbumItemFile[size];
        }
    };
