package com.moment.app.utils.compress;
...
public class SuperCompressor implements Handler.Callback {
  ...
  private SuperCompressor(Builder builder) {
  ...
  public static class Builder {
    ...
    private SuperCompressor build() {
      return new SuperCompressor(this);
    }
